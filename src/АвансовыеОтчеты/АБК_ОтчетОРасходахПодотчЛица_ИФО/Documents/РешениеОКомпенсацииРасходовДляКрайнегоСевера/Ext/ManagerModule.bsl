...
&ИзменениеИКонтроль("ТаблицаДенежныхОбязательствПоРешению")
Функция АБК_ТаблицаДенежныхОбязательствПоРешению(РешениеСсылка)

	Запрос = Новый Запрос;

	Запрос.УстановитьПараметр("Регистратор", РешениеСсылка);

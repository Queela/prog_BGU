...
Процедура АБК_ЗаполнитьПоДоговору(Договор, ЗаполнятьДанныеТабЧастей, ОснованиеЗаполнения)
	...
	//Запрос.УстановитьПараметр("ЗаполнятьДанныеТабЧастей", ЗаполнятьДанныеТабЧастей);
	...
	Если ВидОбязательства = Перечисления.ВидыПринятыхОбязательств.ЗаявкаНаИзменениеОбязательства 

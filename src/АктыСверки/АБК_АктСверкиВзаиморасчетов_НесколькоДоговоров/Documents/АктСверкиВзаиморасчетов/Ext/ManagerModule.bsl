...
&Вместо("ПолучитьДоговорыСКонтрагентом")
Функция АБК_АктСверкиВзаиморасчетов_НесколькоДоговоров_ПолучитьДоговорыСКонтрагентом(ШапкаДокумента)
	...
	//АпогейБК 2022.11.17 Отбор по нескольким договорам
...
Функция АБК_АктСверкиВзаиморасчетов_НесколькоДоговоров_ПолучитьПараметрыЗаполнения1(ПараметрыПроцедуры)
...
Функция АБК_АктСверкиВзаиморасчетов_НесколькоДоговоров_ПолучитьДоговорыСКонтрагентом1(ШапкаДокумента)

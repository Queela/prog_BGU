...
Функция ПолучитьСоответствиеПереименований(ПутьКИсходникам)
	...
	Пока СтрокаПереименования <> Неопределено Цикл
		...
		ПозицияРазделителя = СтрНайти(СтрокаПереименованияВрем, Разделитель);
		...
		ИсходныйПуть = Лев(СтрокаПереименованияВрем, ПозицияРазделителя - 1);
		ПреобразованныйПуть = Сред(СтрокаПереименованияВрем, ПозицияРазделителя + ДлинаРазделителя);
